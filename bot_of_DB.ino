...
const char* ssid = "Dinh"; // change to your home wifi name
const char* password = "12121212"; //  change to your home wifi password
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str())) {
      ...
      client.subscribe("duybao1101@gmail.com/facebook-led"); //  chnage your email id , you can also change facebook-led and keep what ever device name here.
    } else {
